...
**Bản mới nhất:** [v1.0.10](https://github.com/NDCLI/ReID/releases/tag/v1.0.10)

## Cài đặt nhanh

1. Tải `AutoMarkerReID-Setup-1.0.10-win-x64.exe` từ [Release](https://github.com/NDCLI/ReID/releases/latest).
...
.\installer\Build-Setup.ps1 -Version 1.0.10
```
